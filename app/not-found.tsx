  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-28 pb-20">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center max-w-2xl">
        <p className="text-accent font-black text-7xl sm:text-8xl md:text-9xl tracking-tighter mb-4">
          404
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="bg-accent text-primary px-8 py-4 rounded-full font-bold hover:bg-white transition-all duration-300"
          >
            Back to Home
          </Link>
          ...
          <Link
            href="/contact"
            className="bg-white/10 text-white border border-white/30 px-8 py-4 rounded-full font-bold hover:bg-white/20 transition-all duration-300"
          >
            Contact Us
          </Link>
        </div>
